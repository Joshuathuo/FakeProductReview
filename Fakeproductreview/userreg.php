...
$sql=("INSERT INTO users(firstName,email,Pass) VALUES('$UserName','$email','$Pass')");
...
<p style="margin:10px 400px 0 400px;padding-left:50px;background:yellow; color:black; font-size:xx-large;"> registered succesfully Go to the <a style="color:blue; font-size:xx-large; text-decoration:none;" href="userlog.php">Login</a> page</p>
                ...
                <form action="" method="POST" autocomplete="off">
                    <div class="form-main">
                        ...
                        <div class="login-register-text">
                            <p class="login-register-text">Already have an account? <a href="userlog.php">Login</a></p>
                            </div>
