...
<body>
    <div class="container">
    <div class="logo">
            <h1>FAKE PRODUCT REVIEW MONITORING SYSTEM</h1>
    </div>
        ...
        <div class="main-section">
            <div class="main-section-content">
               <p style="color: white; font-size:large; font-family:Arial, Helvetica, serif">
                Fake product review monitoring system is primarily concerned with checking the level of correcteness of a product before its sale .</p> 
               <br>
               <p style="color: yellow; font-size:large; font-family:Arial, Helvetica, serif"> 
...
<div class="contact-main">
   ...
   <p style="text-align: center; color:white; font-size:larger; padding-top:5px"> Designed by JEREMIAH at Meru University of Science and Technology, 2022 © copyright</p>
    </div>
</body>
</html>