  ...
  <li class="dropdown">
   ...
   <div class="log">
       ...
       <div class="admin__main-section">
          ...
          <div>
            <!-- // dashboard.php -->
          <a href="userdashboard.php?info=profile"><i class="fa fa-user"></i>
          <P>PROFILE</P>   
          </a>
          </div>
          
          <div>
          <a href="userdashboard.php?info=userViewProduct" class="">
            <i class="fa fa-eye"></i>
            <p>VIEW PRODUCT</p>
          </a>
          </div>
          ...
          <div>
          <a href="userdashboard.php?info=changePassword" class="">
            <i class="fa fa-eye"></i>
            <p>CHANGE PASSWORD</p>
          </a>
          </div>
          ...
          <P>Book slot</P> 
           -->
             ...
             <div class="admin-form">
				...
				// 	}
          if($info=="userViewProduct")
				{
					include('userViewProduct.php');
					}
